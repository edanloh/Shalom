...
import { Users, TrendingUp, Clock, Target, Download, Share2, Search, Award, BookOpen, GraduationCap, BarChart3 } from "lucide-react";
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-6 py-8 space-y-8">
        ...
        <Tabs value={viewMode} onValueChange={(v) => {
          ...
          <TabsList>
            <TabsTrigger value="all">All Courses Overview</TabsTrigger>
            <TabsTrigger value="course">Individual Course Analytics</TabsTrigger>
          </TabsList>
              ...
              <Card className="p-6 gradient-card border-border">
                ...
                <ResponsiveContainer width="100%" height={300}>
                  <BarChart data={studentActivityData}>
                    ...
                    />
                    <Legend />
                    <Bar dataKey="active" stackId="a" fill="hsl(var(--success))" radius={[0, 0, 0, 0]} name="Active Students" />
                    <Bar dataKey="inactive" stackId="a" fill="hsl(var(--muted))" radius={[8, 8, 0, 0]} name="Inactive Students" />
                  </BarChart>
                </ResponsiveContainer>
              </Card>
              ...
              <Card className="p-6 gradient-card border-border">
                ...
                <ResponsiveContainer width="100%" height={300}>
                  <BarChart data={coursePerformance}>
                    <CartesianGrid strokeDasharray="3 3" stroke="hsl(var(--border))" />
                    <XAxis dataKey="course" stroke="hsl(var(--muted-foreground))" angle={-45} textAnchor="end" height={100} />
                    <YAxis stroke="hsl(var(--muted-foreground))" />
                    <Tooltip 
                      contentStyle={{ 
                        backgroundColor: "hsl(var(--card))", 
                    ...
                    />
                    <Legend />
                    <Bar dataKey="engagement" fill="hsl(var(--primary))" radius={[8, 8, 0, 0]} name="Engagement %" />
                    <Bar dataKey="completion" fill="hsl(var(--success))" radius={[8, 8, 0, 0]} name="Completion %" />
                  </BarChart>
                </ResponsiveContainer>
              </Card>
              ...
              <div className="space-y-4">
                ...
                {filteredCourses.length === 0 && (
                  <Card className="p-12 gradient-card border-border text-center">
                    ...
                    <p className="text-lg text-muted-foreground">No courses found matching "{searchQuery}"</p>
                  </Card>
                )}
              </div>
            ) : (
              <>
                  ...
                  <Card className="p-6 gradient-card border-border">
                    ...
                    <ResponsiveContainer width="100%" height={300}>
                      <BarChart data={singleCourseModuleData}>
                        ...
                        <Bar dataKey="avgScore" fill="hsl(var(--success))" radius={[8, 8, 0, 0]} name="Avg Score %" />
                      </BarChart>
                    </ResponsiveContainer>
                  </Card>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <Card className="p-6 gradient-card border-border text-center">
                    ...
                    <p className="text-3xl font-bold mb-1">{selectedCourse?.completion}%</p>
                  ...
                  <Card className="p-6 gradient-card border-border text-center">
                    ...
                    <p className="text-3xl font-bold mb-1">{selectedCourse?.rating}</p>
