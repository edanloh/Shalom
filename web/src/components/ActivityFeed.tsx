...
export const ActivityFeed = () => {
  ...
  const getIconStyles = (type: Activity["type"]) => {
    switch (type) {
      ...
      case "message":
        return { backgroundColor: `${Colors.purple400}20`, color: Colors.purple400 };
      case "achievement":
        return { backgroundColor: `${Colors.yellow}20`, color: Colors.yellow };
      default:
        return { backgroundColor: `${Colors.surface}50`, color: Colors.textPrimary };
    }
  };
          ...
          <div className="space-y-4">
            {activities.map((activity) => {
              ...
              return (
                <div
                  key={activity.id}
                  className="flex gap-4 p-4 rounded-lg transition-all duration-300 hover:scale-105 hover:shadow-md"
                  style={{ 
                ...
                >
                  <div
                    className="p-2 flex justify-center items-center rounded-lg w-10 h-10 transition-all duration-300 hover:scale-110"
                    style={{
                      ...iconStyles,
