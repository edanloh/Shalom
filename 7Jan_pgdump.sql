...
ALTER TABLE "public"."credits_balance" OWNER TO "postgres";
...
ALTER TABLE ONLY "public"."credits_balance"
    ADD CONSTRAINT "credits_balance_pkey" PRIMARY KEY ("user_id");
...
ALTER TABLE ONLY "public"."credits_balance"
    ADD CONSTRAINT "credits_balance_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id");
...
GRANT ALL ON TABLE "public"."credits_balance" TO "anon";
GRANT ALL ON TABLE "public"."credits_balance" TO "authenticated";
GRANT ALL ON TABLE "public"."credits_balance" TO "service_role";
