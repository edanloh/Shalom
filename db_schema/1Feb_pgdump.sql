...
CREATE TABLE IF NOT EXISTS "public"."course_resources" (
    ...
    CONSTRAINT "course_resources_resource_type_check" CHECK ((("resource_type")::"text" = ANY ((ARRAY['pdf'::character varying, 'document'::character varying, 'ppt'::character varying, 'slides'::character varying, 'worksheet'::character varying, 'ebook'::character varying, 'other'::character varying])::"text"[])))
);
