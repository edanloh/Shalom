...
CREATE OR REPLACE VIEW "public"."courses_with_stats" AS
 SELECT "c"."id",
  ...
  GROUP BY "c"."id", "c"."title", "c"."description", "c"."instructor_name", "c"."category_id", "c"."duration_hours", "c"."thumbnail_url", "c"."is_published", "c"."is_featured", "c"."language", "c"."tags", "c"."created_at", "c"."updated_at", "cat"."name", "cat"."color";
