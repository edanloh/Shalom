...
CREATE OR REPLACE FUNCTION "public"."get_section_completion"("p_user_id" "uuid", "p_section_id" "uuid") RETURNS TABLE("completed_videos" bigint, "passed_quizzes" bigint)
    LANGUAGE "plpgsql"
    AS $$
BEGIN
  RETURN QUERY
...
COMMENT ON FUNCTION "public"."get_section_completion"("p_user_id" "uuid", "p_section_id" "uuid") IS 'Returns count of completed videos and passed quizzes for a user in a given section';



CREATE OR REPLACE FUNCTION "public"."get_section_totals"("p_section_id" "uuid") RETURNS TABLE("total_videos" bigint, "total_quizzes" bigint)
    LANGUAGE "plpgsql"
    AS $$
BEGIN
  RETURN QUERY
...
COMMENT ON FUNCTION "public"."get_section_totals"("p_section_id" "uuid") IS 'Returns total count of videos and quizzes in a given section';
